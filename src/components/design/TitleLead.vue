    ...
    export default {
        ...
        data() {
            return {
                ...
                tmp: '<div style="position:relative;margin-bottom:BOTTOMpx;margin-top:TOPpx;margin-left:10px;    text-align:left"><strong style="color:FONTCOLOR;font-family:FONTTYPE; font-size:FONTSIZEpx">TEXT</strong></div>'
          }
        },
        computed: {
            ...mapState ({
        ...
        mounted() {
            if (this.designCurrentData && this.designCurrentData.data){
                ...
                if (!this.title_lead.font_color) {
                    this.title_lead.font_color = "#FFFFFF";   
                }
