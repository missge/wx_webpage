        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    img.width = 113;
                    //add by bert
                    img.setAttribute("_data_id",list[i].legacy_id)
                    img.setAttribute("_data_album_id",list[i].legacy_id)
            ...
            for (i = 0; i < lis.length; i++) {
                if (domUtils.hasClass(lis[i], 'selected')) {
                    var img = lis[i].firstChild,
                        ...
                        data_id = img.getAttribute('_data_id'),
                        data_album_id = img.getAttribute('_data_album_id');
                    list.push({
                        src: src,
                        _src: src,
                        data_id: data_id || '',
